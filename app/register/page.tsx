        ...
        <div className="hidden lg:flex flex-col justify-center px-8 xl:px-12 bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-md">
            ...
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Create your account and get started with role-based access to your personalized dashboard.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-slate-300">
                ...
                <span>Admin access with invite code</span>
              </div>
              <div className="flex items-center gap-3 text-slate-300">
        ...
        <div className="flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8 xl:px-12">
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="hidden lg:block mb-8">
              ...
              <p className="mt-2 text-slate-600">Get started with your personalized dashboard</p>
            </div>
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <p className="mt-2 text-slate-600">Join your team today</p>
            </div>
